...
public class SortCount {
  ...
  private static void merge(int[] arr, int[] tmp,
                            int leftStart, int leftEnd, int rightStart, int
                              rightEnd) {
  ...
  //Problem 9: Implementation and experimental analysis of swap sort
  ...
  public static void main(String args[]) {
    ...
    int[] mytest = {15, 8, 7, 6, 88,3,206, 20, 5, 12};
    swapSort(mytest);
    System.out.println("mytest Result:" + Arrays.toString(mytest));
  }
}