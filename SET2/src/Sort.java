 ...
 *
 * Your solution to Problem 7 should go in this file.
 *
 * IMPORTANT: Your solution to Problem 9 should go in
...
public class Sort {
  ...
  /**
   * remove duplicate items in a sorted array and return an int that specifies
  ...
  private static boolean testRemoveDups(int[] originalArray,
                                        int[] expectedArray,
                                        int expectedRetValue) {
    int result = removeDups(originalArray);
    if (Arrays.equals(expectedArray, originalArray) && result == expectedRetValue) {
      return true;
    }
    return false;
  };
  ...
  public static void main(String[] arr) {
    ...
    //Problem 7 - removeDups Tests:
    /**
     * test for removeDups function
     */

    System.out.println("remove dups from []: " + (testRemoveDups(new
     int[]{},
      new int[]{}, 0)? "pass" : "fail"));

    System.out.println("remove dups from null: " + (testRemoveDups(null,
      null, 0)? "pass" : "fail"));

    System.out.println("remove dups from [2，3，5]: " + (testRemoveDups(
        new int[]{2,3,5}, new int[]{2,3,5}, 3)? "pass" : "fail"));

    System.out.println("remove dups from [2, 5, 5, 5, 10, 12, 12]: "
      + (testRemoveDups(
      new int[]{2,5,5,5,10,12,12}, new int[]{2, 5, 10, 12, 0, 0, 0}, 4)? "pass" :
      "fail"));
  }
}